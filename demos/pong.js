(() => {
  ...
  const humanPaddleSpeed = 400; // px/s
  ...
  function aiUpdate(dt) {
    ...
    // Nightmare: near-perfect AI for left; right only if AI-controlled
  ...
  settingsBtn && settingsBtn.addEventListener('click', () => { modal.setAttribute('aria-hidden','false'); });
